...
<head>
	...
	<script>
		...
		function adminSiteModifyDetailTest(){
		...
		function adminSiteModifyDetail(){
			editorToTextarea();
			if(adminSiteModifyDetailTest()){
				$("#adminSiteModifyDetail_form").submit();
			}
		}
	</script>
	<!-- Smart Editor -->
...
<body>
  	<form id="adminSiteModifyDetail_form" action="adminSiteModifyDetail" method="post" enctype="multipart/form-data">
		...
		<div class="adminProductDetail_content">
			<a class="adminTop_btn adminTop_btnBlue" onclick="adminSiteModifyDetail();">저장</a>
		</div>
	</form>
