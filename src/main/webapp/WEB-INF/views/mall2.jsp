            ...
            <div class="row">
                <div class="col-xl-3 col-lg-2">
                    <div class="header__logo">
                        <a href="index.jsp"><img src="img/p2_footer_logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a href="p2.jsp">오메란은?</a></li>
                            <li><a href="p3.jsp">오메란 제품 소개</a></li>
                            <li><a href=".p4.jsp">오메란의 효능</a></li>
                            <li><a href="mall.jsp">오메란 쇼핑몰</a>
<!--                                 <ul class="dropdown">
